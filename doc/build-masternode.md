...
======================
Some notes on how to build a SKT Masternode in Ubuntu server. Using Windows Qt Client to configure.
...
Notes
-----
You need exactly 25000 SKT to run a Masternode. Masternode input must have at least 15 confirmations.
...
To fix a broken accountaddress 0 (possible when sending huge amounts of coins away), do a self TX of 25000 SKT.


Start
-----
Open your Windows SKT-Qt Client and open the debug console.
...
-----------------------------------
	...
	mkdir .skt
	cd .skt
	wget http://sourceforge.net/projects/skt/files/skt-linux64.zip
	unzip skt-linux64.zip
	
	$ sudo cp sktd /usr/bin
	$ sudo chmod 775 /usr/bin/sktd

	
	Create a skt.conf in nano
	-------------------------------
	cd .skt
	nano
	---
	...
	---
	@reboot /usr/bin/sktd -shrinkdebugfile    [to start masternode  (or wherever you keep your daemon)]
	*/20 * * * * /usr/bin/sktd
	---
	save nano: Ctrl +  O
	exit nano: Ctrl +  X
	...
	------------------
	./sktd getinfo
	./sktd masternode list
	./sktd masternode debug
	./sktd masternode stop
	./sktd help
	
	
	Start Mining
	----------------------
	./sktd setgenerate true
	./sktd gethashespersec
	

Windows SKT-Qt Client configuration 
-----------------------------------------
(if using a seperate wallet.dat, a seperate skt.conf is needed)

	---
	go to skt.conf in %appdata%
	...
	Windows SKT-Qt Client console
	-----------------------------------
	masternode start <PSW>

	
	Windows SKT-Qt Client console commands
	--------------------------------------------
...
-----------------------------------------
	...
	./skt.cli setgenerate true
	./skt.cli gethashespersec
