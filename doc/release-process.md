...
##perform gitian builds
 ...
 Build sktd and skt-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit skt=v${VERSION} ../skt/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../skt/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r skt-${VERSION}-linux-gitian.zip *
	mv skt-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit skt=v${VERSION} ../skt/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../skt/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r skt-${VERSION}-win-gitian.zip *
	mv skt-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit skt=v${VERSION} ../skt/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
