...
{
public:
    /// Is the inputs associated with this public key? (and there is 14000 SKT - checking if valid masternode)
...
public:
    ...
    void InitCollateralAddress(){
        ...
        if(Params().NetworkID() == CChainParams::MAIN) {
            ...
            strAddress = "y1EZuxhhNMAUofTBEeLqGE1bJrpC2TWRNp"; // Not used SKTdev 01-05
        }
    ...
    /// Get the denominations for a specific amount of skt.
