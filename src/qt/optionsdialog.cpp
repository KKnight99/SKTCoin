    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Blue arrow"), QVariant("skt_main"));
    ui->theme->addItem(QString("Linux red"), QVariant("skt_theme1"));
    ui->theme->addItem(QString("Blue City Sky"), QVariant("skt_theme2"));
	ui->theme->addItem(QString("Lambo Car"), QVariant("skt_theme3"));
